...
This repository coordinates the **two teams** working on the challenge: it holds shared documentation, links to component repositories and datasets, and tracks how the teams' deliverables fit together into a single pipeline.
...
**Goal:** evaluate and benchmark methods for making the archive analysis-ready, then use the result for retrospective flood risk assessment across East Africa — computing rainfall-based exceedance probabilities from ~1,000 days of forecasts and visualising the results cost-effectively.
